...
mkdir -p esp8266-$ESP8266_VER/package
wget --no-clobber http://arduino.esp8266.com/stable/package_esp8266com_index.json -O esp8266-$ESP8266_VER/package/package_esp8266com_index.template.json
